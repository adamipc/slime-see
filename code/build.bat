...
set cl_opts=-Od -Oi -GR- -EHa- -MT -Gm- -FAsc -W4 -WX -wd4127 -wd4100 -wd4189 -wd4201 -wd4505 -FC -Zi -nologo -Fewin32_slime_see -Fmwin32_slime_see.map
set link_opts=/link -opt:ref -subsystem:windows
set clang_opts=-o win32_slime_see.exe
set libs=user32.lib gdi32.lib advapi32.lib winmm.lib
set build_dir=..\..\..\build
